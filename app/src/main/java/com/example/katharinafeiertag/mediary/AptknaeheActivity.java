...
public class AptknaeheActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    private void init() {
        ...
        mGoogleApiClient = new GoogleApiClient.Builder(this)
                ...
                .build();
        Log.d(TAG, "nach GoogleApiClient");
                ...
                location.addOnCompleteListener(new OnCompleteListener() {
                    ...
                    public void onComplete(@NonNull Task task) {
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(AptknaeheActivity.this, "unable to get current location", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
            }
    ...
    /*private void moveCamera(LatLng latLng, float zoom, PlaceInfo placeInfo){
        ...
        mMap.setInfoWindowAdapter(new CustomInfoWindowAdapter(AptknaeheActivity.this));
    ...
    private void getLocationPermission() {
        ...
        if (ContextCompat.checkSelfPermission(this.getApplicationContext(),
            ...
            if (ContextCompat.checkSelfPermission(this.getApplicationContext(),
                ...
                ActivityCompat.requestPermissions(this, permissionGPS,
    ...
    public void onMapReady(GoogleMap map) {
        ...
        if (mLocationPermissionsGranted) {
            ...
            if (ActivityCompat.checkSelfPermission(this, Manifest.permission.ACCESS_FINE_LOCATION)
                    ...
                    Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
                Log.d(TAG, "in der checkSelfPermission Methode");
                return;
            }
